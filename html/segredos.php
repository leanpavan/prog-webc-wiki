...
<main>
    ...
    <section class="home_page">
        <div class="home_content">
            <h2>Segredos | Dark Souls Remastered Wiki</h2>
            <hr>
            <br>
            <p>Segredos em <strong>Dark Souls</strong> e <strong>Dark Souls Remastered</strong> são mecânicas especiais escondidas, localizações e eventos que o jogador pode perder durante
            sua gameplay.
            </p>
