...
<main>
    ...
    <section class="home_page">
        <div class="home_content">
            <h2>Personagens | Dark Souls Remastered Wiki</h2>
            <hr>
            <br>
            <p>Informações sobre os personagens de <a href="sobre_ds.php">Dark Souls</a>, abrange informações mecânicas gerais, como classes e atributos.</p>
